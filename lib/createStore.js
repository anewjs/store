...
var _invariantPersistState = require('./invariantPersistState');

var _invariantPersistState2 = _interopRequireDefault(_invariantPersistState);
...
function createStore() {
    ...
    (0, _invariantPersistState2.default)(name, state, persist);
    (0, _invariantFunctionProperty2.default)(name, 'store creation');
    (0, _invariant2.default)((typeof reducer === 'undefined' ? 'undefined' : _typeof(reducer)) !== 'object', 'Wrong type "reducer" was passed as an object instead of a function ' + ('for the store named "' + name + '". It seems like you accidentally ') + 'spelled reducers as reducer. The reducer parameter can only be a ' + 'function, recieved an object instead.');
     ...
     */
    var enhancerWithMiddlewares = _redux.compose.apply(undefined, _toConsumableArray(enhancer ? [enhancer] : []).concat([(0, _redux.applyMiddleware)(createBatchMiddleware(anewProps.getBatches))]));
    ...
    var _f = function _f(_ref3) {
        ...
        if ((0, _invariantFunctionProperty2.default)(selectorName, name)) {
            var selectorWithParams = function selectorWithParams() {
