...
function () {
    ...
    if (plugins.length) {
      var param = {
        ...
        inject: function inject(updates) {
          Object.entries(updates).forEach(function (_ref3) {
            var updateType = _ref3[0],
                update = _ref3[1];
  ...
  _proto._installModules = function _installModules(modules, storage) {
    ...
    Object.entries(modules).forEach(function (_ref4) {
  ...
  _proto._installGetters = function _installGetters(getters, getState) {
    ...
    Object.entries(getters).forEach(function (_ref5) {
      var getName = _ref5[0],
          get = _ref5[1];
  ...
  _proto._installSelectors = function _installSelectors(selectors, storage, store) {
    ...
    Object.entries(selectors).forEach(function (_ref6) {
      ...
      switch (typeof selector) {
        case 'function':
          ...
          storage[selectorName] = function (args) {
            if (args === void 0) {
              args = {};
            }

            return memoizedSelector(store.get(), args);
          };
  ...
  _proto._installReducers = function _installReducers(reducers, storage, stateRef, getState, prefix, propagate) {
    ...
    if (propagate === void 0) {
      propagate = typeof stateRef !== 'object' ? function (change) {
        ...
        _this6.state = Object.assign({}, _this6.state, containerName ? (_ref7 = {}, _ref7[containerName] = change, _ref7) : change);
        return _this6.state;
      };
    }

    Object.entries(reducers).forEach(function (_ref8) {
      var reducerName = _ref8[0],
          reducer = _ref8[1];
      ...
      switch (typeof reducer) {
        ...
        case 'object':
          ...
          var nextPropogation = targetState && typeof targetState !== 'object' ? function (change) {
            ...
            return propagate(Object.assign(objectInstance, targetGetState(), containerName ? (_ref9 = {}, _ref9[containerName] = change, _ref9) : change), reducerName);
          };
  ...
  _proto._installActions = function _installActions(actions, storage, store, prefix) {
    ...
    Object.entries(actions).forEach(function (_ref10) {
      var actionName = _ref10[0],
          action = _ref10[1];
