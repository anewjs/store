...
function () {
  function Store(options) {
    ...
    _defineProperty(this, "callPathInSiblingReducers", function (reducers, path, state, parentState) {
        ...
        Object.entries(reducers).forEach(function (_ref) {
          ...
          if (reducer.on) {
            ...
            if (typeof targetReducer === 'function') {
              _this.updateState(parentState[reducerName], targetReducer.apply(void 0, [parentState[reducerName], state].concat(args)));
            }
          }
        });
      }
    ...
    _defineProperty(this, "updateState", function (state, change, stateKey) {
  ...
  _proto.installReducers = function installReducers(reducers, storage, parentReducers, state, parentState, getState, prefix, isLevelUp) {
    var _this5 = this;
    ...
    Object.entries(reducers).forEach(function (_ref6) {
      ...
      switch (typeof reducer) {
        case 'function':
          ...
          if (isLevelUp) {
            ...
            storage[reducerName] = function () {
              ...
              _this5.updateState(parentState, reducer.apply(void 0, [getState()].concat(args)), stateKey);

              _this5.callPathInSiblingReducers.apply(_this5, [parentReducers, path, parentState[stateKey], parentState].concat(args));
            ...
            storage[reducerName] = function () {
              ...
              _this5.updateState(state, reducer.apply(void 0, [getState()].concat(args)));

              _this5.callPathInSiblingReducers.apply(_this5, [parentReducers, path, state, parentState].concat(args));
        ...
        case 'object':
          ...
          _this5.installReducers(reducer, storage[reducerName], reducers, state[reducerName], state, function () {
