        ...
        case 'function':
          if (typeof state !== 'object' && !stateKey) {
            ...
            storage[reducerName] = function () {
              ...
              var change = reducer.apply(void 0, [_this6.state].concat(args));
              _this6._stateHasChanged = change && change !== _this6.state;
            ...
            storage[reducerName] = function () {
              ...
              _this6._stateHasChanged = change && change !== parentState[stateKey];
            ...
            storage[reducerName] = function () {
              ...
              var change = reducer.apply(void 0, [getState()].concat(args));
              _this6._stateHasChanged = change && change !== state;
