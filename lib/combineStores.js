...
var _createCombinedReducer = require('./createCombinedReducer');
...
function combineStores(_ref) {
  ...
  var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      _ref2$createCombinedR = _ref2.createCombinedReducer,
      createCombinedReducer = _ref2$createCombinedR === undefined ? _createCombinedReducer2.default : _ref2$createCombinedR,
   ...
   * Combine Redux Store
   */
  var reduxReducer = combineReducers(anewStore, stores, persist);

  /**
   * Generate Combined Anew Store
   */
  var anewReducer = createCombinedReducer(anewStore, reduxReducer);
